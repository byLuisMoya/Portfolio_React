...
export const Contact = () => {
  ...
  //   } else {
  //     setStatus({ succes: false, message: 'Algo ha ido mal, por favor inténtelo de nuevo mas tarde.'});
  //   }
  // };
              ...
              {({ isVisible }) =>
                ...
                <form>
                  <Row>
                    ...
                    <Col size={12} sm={6} className="px-1">
                      <input type="tel" value={formDetails.phone} placeholder="Numero de Contacto" onChange={(e) => onFormUpdate('phone', e.target.value)}/>
                    </Col>
